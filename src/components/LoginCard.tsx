  ...
  return (
    <div className="card w-full max-w-sm p-8 flex flex-col items-center gap-6">
      <div className="flex flex-col items-center gap-3">
        <img src={logo} alt="trankilo-ai" className="w-44 h-auto" />
        <div className="text-center">
          <h1 className="text-xl font-semibold text-zinc-900">trankilo-ai 🦥</h1>
          <p className="text-sm text-zinc-500 mt-1">The Agent Registry</p>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col gap-2">
        ...
        <button onClick={handleGithub} disabled={loading} className="btn-secondary w-full">
